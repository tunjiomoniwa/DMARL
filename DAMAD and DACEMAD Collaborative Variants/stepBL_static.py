...
def stepBL_static(action, x1, y1, z1, e1, dist1):
    ...
    #### Propulsion energy consumption settings
    ...
    if (action == 1): #%means north
        ...
        e1 = e1 + energydrain
        dist1 = dist1  + mobilitystep 
    elif (action == 15): #%means up
        y1 = y1
        x1 = x1
        z1 = z1 + altitudestep
        e1 = e1 + energydrainUp
        dist1 = dist1  + altitudestep 
    elif (action == 16): #%means down
        y1 = y1
        x1 = x1
        z1 = z1 - altitudestep

...
cmad_ene_ = sum(dlmread('Energy_N7_Saturation_cmad.dat'));
...
mad_ene_ = sum(dlmread('Energy_N7_Saturation_mad.dat'));
...
dace_ene_ = sum(dlmread('Energy_N7_saturation_dacemad.dat')); %%Energy_DEMAD_test_2.dat
...
damad_ene_ = sum(dlmread('Energy_N7_saturation_damad.dat')); %%
...
maddpg_ene_ = sum(dlmread('Energy_DDPG_N7_sat.dat'));

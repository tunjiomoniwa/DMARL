...
Energy_10Uavs_damad = sum(dlmread('Energy_data_box_test_4.dat'))./1000;
Energy_10Uavs_dacemad = sum(dlmread('Energy_DEMAD_test_2.dat'))./1000;
Energy_10Uavs_cmad = sum(dlmread('Energy_M50_MAD3.dat'))./1000; 
Energy_10Uavs_mad = sum(dlmread('Energy_M50_CMAD2.dat'))./1000; 

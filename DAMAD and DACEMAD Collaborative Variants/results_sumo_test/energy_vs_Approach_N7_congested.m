...
cmad_ene_ = sum(dlmread('Energy_N7_congested_cmad.dat'));
...
mad_ene_ = sum(dlmread('Energy_N7_congested_mad.dat'));
...
dace_ene_ = sum(dlmread('Energy_N7_congested_dacemad.dat')); %%Energy_DEMAD_test_2.dat
...
damad_ene_ = sum(dlmread('Energy_N7_congested_damad.dat')); %%
...
maddpg_ene_ = sum(dlmread('Energy_DDPG_N7_con.dat'));

...
ee_10Uavs_dacemad = dlmread('ee_N7_freeflow_dacemad.dat');
ee_10Uavs_damad = dlmread('ee_N7_freeflow_damad.dat');
ee_10Uavs_mad = dlmread('ee_N7_freeflow_mad.dat');
ee_10Uavs_cmad = dlmread('ee_N7_freeflow_cmad.dat');

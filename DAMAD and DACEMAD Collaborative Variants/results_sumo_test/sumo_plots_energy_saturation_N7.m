...
Energy_10Uavs_dacemad = sum(dlmread('Energy_N7_saturation_dacemad.dat'))./1000;
Energy_10Uavs_damad = sum(dlmread('Energy_N7_saturation_damad.dat'))./1000;
Energy_10Uavs_mad = sum(dlmread('Energy_N7_Saturation_mad.dat'))./1000; 
Energy_10Uavs_cmad = sum(dlmread('Energy_N7_Saturation_cmad.dat'))./1000; 

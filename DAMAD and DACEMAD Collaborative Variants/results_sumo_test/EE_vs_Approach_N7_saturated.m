...
%%%%DDQN Communication
cmad_EE_ = dlmread('ee_N7_Saturation_mad.dat');
...
%%%%%%%%
mad_EE_ = dlmread('ee_N7_Saturation_cmad.dat');
...
%%%%%%%%%%%
dace_EE_ = dlmread('ee_N7_saturation_dacemad.dat'); %%ee_DEMAD_2.dat
...
%%%%%%%%%
%%%%%%%%%%%
damad_EE_ = dlmread('ee_N7_saturation_damad.dat'); %%ee_DEMAD_2.dat
...
%%%%%%%%%
maddpg_EE_ = dlmread('ee_DDPG_N7_sat.dat');
...
position_cmad = 6;  
box_CMAD_ee = boxplot(max(0.002,CMAD_ee),'colors','k','positions',position_cmad,'width',1, 'BoxStyle',"filled"); 
set(gca,'XTickLabel',{' '})  % Erase xlabels   
hold on  % Keep the Month_O boxplots on figure overlap the Month_S boxplots   

position_mad = 8;  
box_MAD_ee = boxplot(MAD_ee,'colors','g','positions',position_mad,'width',1, 'BoxStyle',"filled"); 
set(gca,'XTickLabel',{' '})  % Erase xlabels   
hold on  % Keep the Month_O boxplots on figure overlap the Month_S boxplots   
...
box_DDPG_ee = boxplot(max(0.001, DDPG_ee),'colors','c','positions',position_DDPG_ee,'width',1, 'BoxStyle',"filled"); 

...
Energy_10Uavs_dacemad = sum(dlmread('Energy_N7_freeflow_dacemad.dat'))./1000;
Energy_10Uavs_damad = sum(dlmread('Energy_N7_freeflow_damad.dat'))./1000;
Energy_10Uavs_mad = sum(dlmread('Energy_N7_freeflow_mad.dat'))./1000; 
Energy_10Uavs_cmad = sum(dlmread('Energy_N7_freeflow_cmad.dat'))./1000; 
...
axis([2 250 50 max(Energy_10Uavs_dacemad)+10e3])
grid on;

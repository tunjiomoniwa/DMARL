...
Energy_10Uavs_dacemad = sum(dlmread('Energy_m50_saturation_dacemad.dat'))./1000;
Energy_10Uavs_damad = sum(dlmread('Energy_m50_saturation_damad.dat'))./1000;
Energy_10Uavs_mad = sum(dlmread('Energy_M50_Saturation_mad.dat'))./1000; 
Energy_10Uavs_cmad = sum(dlmread('Energy_M50_Saturation_cmad.dat'))./1000; 
...
axis([2 250 300 max(Energy_10Uavs_dacemad)+10e3])
grid on;

...
cmad_Cov_ = sum(dlmread('Covered_vehicles_M50_congested_cmad.dat'));
cmad_Dep_ = dlmread('deployed_vehicles_M50_congested_cmad.dat');
...
mad_Cov_ = sum(dlmread('Covered_vehicles_M50_congested_mad.dat'));
mad_Dep_ = dlmread('deployed_vehicles_M50_congested_mad.dat');
...
dace_Cov_ = sum(dlmread('Covered_vehicles_m50_congested_dacemad.dat')); %%Covered_vehicles_DEMAD_2.dat
dace_Dep_ = dlmread('deployed_vehicles_m50_congested_dacemad.dat'); %%deployed_vehicles_DEMAD_2.dat
...
damad_Cov_ = sum(dlmread('Covered_vehicles_m50_congested_damad.dat')); %%
damad_Dep_ = dlmread('deployed_vehicles_m50_congested_damad.dat'); %%
...
maddpg_Cov_ = sum(dlmread('Covered_vehicles_DDPG_M50_con.dat'));
maddpg_Dep_ = dlmread('deployed_vehicles_DDPG_M50_con.dat');

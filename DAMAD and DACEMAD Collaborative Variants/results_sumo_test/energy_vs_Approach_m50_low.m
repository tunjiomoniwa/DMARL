...
cmad_ene_ = sum(dlmread('Energy_N7_freeflow_cmad.dat'));
...
mad_ene_ = sum(dlmread('Energy_N7_freeflow_mad.dat'));
...
dace_ene_ = sum(dlmread('Energy_N7_freeflow_dacemad.dat')); %%Energy_DEMAD_test_2.dat
...
damad_ene_ = sum(dlmread('Energy_N7_freeflow_damad.dat')); %%
...
maddpg_ene_ = sum(dlmread('Energy_DDPG_M50.dat'));

...
ee_10Uavs_dacemad = dlmread('ee_N7_saturation_dacemad.dat');
ee_10Uavs_damad = dlmread('ee_N7_saturation_damad.dat');
ee_10Uavs_mad = dlmread('ee_N7_Saturation_cmad.dat');
ee_10Uavs_cmad = dlmread('ee_N7_Saturation_mad.dat');

...
ee_10Uavs_dacemad = dlmread('ee_m50_saturation_dacemad.dat');
ee_10Uavs_damad = dlmread('ee_m50_saturation_damad.dat');
ee_10Uavs_mad = dlmread('ee_M50_Saturation_mad.dat');
ee_10Uavs_cmad = dlmread('ee_M50_Saturation_cmad.dat');
...
a2 = axes();
a2.Position = [0.600 0.3400 0.25 0.2]; 

...
cmad_ene_ = sum(dlmread('Energy_M50_Saturation_cmad.dat'));
...
cmad_energy = cmad_ene_(200:250)';

%%%%%%%%
mad_EE_ = dlmread('ee_M50_MAD3.dat');
mad_ene_ = sum(dlmread('Energy_M50_Saturation_mad.dat'));
...
mad_energy = mad_ene_(200:250)';

%%%%%%%%%%%
dace_EE_ = dlmread('ee_box_test_4.dat'); %%ee_DEMAD_2.dat
dace_ene_ = sum(dlmread('Energy_m50_saturation_dacemad.dat')); %%Energy_DEMAD_test_2.dat
...
dace_energy = dace_ene_(200:250)';

%%%%%%%%%
%%%%%%%%%%%
damad_EE_ = dlmread('ee_DEMAD_2.dat'); %%ee_DEMAD_2.dat
damad_ene_ = sum(dlmread('Energy_m50_saturation_damad.dat')); %%
...
damad_energy = damad_ene_(200:250)';
...
maddpg_ene_ = sum(dlmread('Energy_DDPG_M50_sat.dat'));

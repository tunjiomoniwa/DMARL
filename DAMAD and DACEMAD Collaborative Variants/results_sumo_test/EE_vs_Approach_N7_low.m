...
cmad_EE_ = dlmread('ee_N7_freeflow_cmad.dat');
...
%%%%%%%%
mad_EE_ = dlmread('ee_N7_freeflow_mad.dat');
...
%%%%%%%%%%%
dace_EE_ = dlmread('ee_N7_freeflow_dacemad.dat'); %%ee_DEMAD_2.dat
...
%%%%%%%%%
%%%%%%%%%%%
damad_EE_ = dlmread('ee_N7_freeflow_damad.dat'); %%ee_DEMAD_2.dat
...
%%%%%%%%%
maddpg_EE_ = dlmread('ee_DDPG_N7_low.dat');

...
Energy_10Uavs_dacemad = sum(dlmread('Energy_m50_congested_dacemad.dat'))./1000;
Energy_10Uavs_damad = sum(dlmread('Energy_m50_congested_damad.dat'))./1000;
Energy_10Uavs_mad = sum(dlmread('Energy_M50_congested_mad.dat'))./1000; 
Energy_10Uavs_cmad = sum(dlmread('Energy_M50_congested_cmad.dat'))./1000; 

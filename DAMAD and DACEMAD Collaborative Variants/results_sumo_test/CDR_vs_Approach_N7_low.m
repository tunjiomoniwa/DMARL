...
cmad_Cov_ = sum(dlmread('Covered_vehicles_N7_freeflow_cmad.dat'));
cmad_Dep_ = dlmread('deployed_vehicles_N7_freeflow_cmad.dat');
cmad_Cov = cmad_Cov_(200:250)';
cmad_Dep = cmad_Dep_(200:250)';
cmad_CDR =  cmad_Cov./cmad_Dep;


mad_Cov_ = sum(dlmread('Covered_vehicles_N7_freeflow_mad.dat'));
mad_Dep_ = dlmread('deployed_vehicles_N7_freeflow_mad.dat');
...
dace_Cov_ = sum(dlmread('Covered_vehicles_N7_freeflow_dacemad.dat')); %%Covered_vehicles_DEMAD_2.dat
dace_Dep_ = dlmread('deployed_vehicles_N7_freeflow_dacemad.dat'); %%deployed_vehicles_DEMAD_2.dat
...
damad_Cov_ = sum(dlmread('Covered_vehicles_N7_freeflow_damad.dat')); %%
damad_Dep_ = dlmread('deployed_vehicles_N7_freeflow_damad.dat'); %%
...
maddpg_Cov_ = sum(dlmread('Covered_vehicles_DDPG_N7_low.dat'));
maddpg_Dep_ = dlmread('deployed_vehicles_DDPG_N7_low.dat');

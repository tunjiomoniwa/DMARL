...
%%%%DDQN Communication
cmad_EE_ = dlmread('ee_M50_Saturation_cmad.dat');
...
%%%%%%%%
mad_EE_ = dlmread('ee_M50_Saturation_mad.dat');
...
%%%%%%%%%%%
dace_EE_ = dlmread('ee_m50_saturation_dacemad.dat'); %%ee_DEMAD_2.dat
...
%%%%%%%%%
%%%%%%%%%%%
damad_EE_ = dlmread('ee_m50_saturation_damad.dat'); %%ee_DEMAD_2.dat
...
%%%%%%%%%
maddpg_EE_ = dlmread('ee_DDPG_M50_sat.dat');

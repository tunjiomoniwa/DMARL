...
def stepBL1_static(action, x1, y1, z1, e1, dist1):
    ...
    done1= bool(energy1 <= 5000000 and z1>=390 and x1>=200 and x1<=300 and y1>=200 and y1<=300)
    ##done1= bool(energy1 <= 5000000 and z1>=390 and x1>=200 and y1>=200)
    #done1= bool(energy1 <= 5000000 and z1>=390 and x1>=180 and y1>=180)
